...
function ManageExpense({ route, navigation }) {
    ...
    async function confirmHandler(expenseData) {
        ...
        try {
            ...
            setError('Could not save data - pleas try again later!');
            setIsSubmitting(false);
        }
    }
    ...
    return <View style={styles.container}>
        ...
        {isEditing && <View style={styles.deleteContainer}><IconButton icon="trash" color={GlobalStyles.colors.error500} size={36} onPress={deleteExpenseHandler} /></View>}
        </View>
}
